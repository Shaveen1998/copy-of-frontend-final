  ...
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="https://i.postimg.cc/nVP8CSJt/edvin-johansson-rlw-E8f8an-Oc-unsplash.jpg" alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">Kingsburry Hotels</span>
          <span class="float-right text-gray-400">42EU - 8.5US</span>
          <p class="text-lg font-bold">$138.99</p>
        </div>
      </div>
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="https://i.postimg.cc/3Rx6wmfR/kelsey-curtis-27u-Gzl-AFw-unsplash.jpg" alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">Hilton Hotels</span>
          <span class="float-right text-gray-400">42EU - 8.5US</span>
